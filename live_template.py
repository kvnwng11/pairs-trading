...
if old_signal == 0 and signal == 1:
    buy(pair[0], ,curr_price0)
    short(pair[1], ,curr_price1)
elif old_signal == 0 and signal == -1:
    short(pair[0], ,curr_price0)
    buy(pair[1], ,curr_price1)
elif old_signal == 1 and signal == 0:
    sell(pair[0], ,curr_price0)
    cover(pair[1], ,curr_price1)
elif old_signal == -1 and signal == 0:
    cover(pair[0], ,curr_price0)
    sell(pair[1], ,curr_price1)
